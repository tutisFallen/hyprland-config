...
This configuration uses the following packages. They can be installed automatically using `pacotes.sh` or manually.
...
- Ensure all required packages are installed: `./pacotes.sh`
...
├── pacotes.sh              # Package installation script
└── README.md
```
